...
[![npm version](https://badge.fury.io/js/grunt-sftp-deploy-i.svg)](http://badge.fury.io/js/grunt-sftp-deploy-i) ![dependency](https://david-dm.org/arsssen/grunt-sftp-deploy.svg)

[![NPM](https://nodei.co/npm/grunt-sftp-deploy-i.png?downloads=true&downloadRank=true&stars=true)](https://nodei.co/npm/grunt-sftp-deploy-i/) [![NPM](https://nodei.co/npm-dl/grunt-sftp-deploy-i.png?months=9&height=3)](https://nodei.co/npm/grunt-sftp-deploy-i/)
